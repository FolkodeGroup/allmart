          ...
          >
            ...
            <div className={styles.fieldGroup}>
              <label htmlFor="phone" className={styles.label}>
                Celular <span aria-hidden="true" className={styles.required}>*</span>
              </label>
              <input
                id="phone"
                type="tel"
                ...
                {...register('phone', { setValueAs: v => typeof v === 'string' ? v.trim() : v })}
              />
              {errors.phone && (
            ...
            <div className={styles.actions}>
              ...
              <button type="submit" className={styles.confirmBtn} disabled={!isValid || isSubmitting}>
                <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" className={styles.confirmBtnIcon}>
